# coding=utf-8
#extraido de https://github.com/jeonsworld/ViT-pytorch/blob/main/models/modeling.py
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False):
        ...
        self.head = Linear(config.hidden_size, num_classes)#misma salida que resnet 50
